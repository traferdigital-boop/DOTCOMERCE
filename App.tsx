      ...
      <footer className="bg-white py-16 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-500 text-[10px] leading-relaxed">
                A Dotcomerce e a Trafer Digital são parceiras oficiais das plataformas listadas. Podemos receber comissões por indicações, o que não altera o preço final para você e garante nosso conteúdo gratuito.
              </p>
            </div>
          </div>
          <div className="text-center pt-8 border-t border-slate-100 text-slate-400 text-[10px]">
            ...
            <p className="mt-1">Página criada com carinho por <span className="text-indigo-400 font-semibold">Trafer Digital</span>.</p>
          </div>
        </div>
      </footer>
    </div>
